...
wx.BaaS.init('1234567', {env: 'dev'})
wx.BaaS.init('1234567', {autoLogin: false, logLevel: 'info', host: 'http://****'})
wx.BaaS.init('1234567', {autoLogin: false, logLevel: 'info', host: 'http://****', env: 'dev'})
...
qq.BaaS.init('1234567', {env: 'dev'})
qq.BaaS.init('1234567', {autoLogin: false, logLevel: 'info', host: 'http://****', env: 'dev'})
...
my.BaaS.init('1234567', {env: 'dev'})
my.BaaS.init('1234567', {autoLogin: false, logLevel: 'info', host: 'http://****', env: 'dev'})
...
swan.BaaS.init('1234567', {env: 'dev'})
swan.BaaS.init('1234567', {autoLogin: false, logLevel: 'info', host: 'http://****', env: 'dev'})
...
window.BaaS.init('1234567', {env: 'dev'})
window.BaaS.init('1234567', {autoLogin: false, logLevel: 'info', host: 'http://****', env: 'dev'})
