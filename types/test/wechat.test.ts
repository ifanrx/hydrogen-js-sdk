...
wx.BaaS.auth.loginWithWechat(null, {syncUserProfile: 'false', loginWithUnionid: true})
wx.BaaS.auth.loginWithWechat(null, {syncUserProfile: 'false', loginWithUnionid: true, createUser: true})
...
wx.BaaS.auth.loginWithWechat({detail: {userInfo: {}, encryptedData: '', iv: '', signature: '', rawData: ''}}, {syncUserProfile: 'false', createUser: true, loginWithUnionid: true})
