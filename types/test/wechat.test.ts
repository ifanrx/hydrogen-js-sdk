...
wx.BaaS.auth.loginWithWechat(null, {syncUserProfile: 'false', withUnionID: true})
wx.BaaS.auth.loginWithWechat(null, {syncUserProfile: 'false', withUnionID: true, createUser: true})
...
wx.BaaS.auth.loginWithWechat({detail: {userInfo: {}, encryptedData: '', iv: '', signature: '', rawData: ''}}, {syncUserProfile: 'false', createUser: true, withUnionID: true})
