...
const API = {
  ...
  RECORD_LIST: '/hserve/v2.3/table/:tableID/record/',
  QUERY_RECORD_LIST: '/hserve/v2.3/table/:tableID/record/',
  CREATE_RECORD_LIST: '/hserve/v2.3/table/:tableID/record/?enable_trigger=:enable_trigger',
  RECORD_DETAIL: '/hserve/v2.3/table/:tableID/record/:recordID/',
  CREATE_RECORD: '/hserve/v2.3/table/:tableID/record/',
  UPDATE_RECORD: '/hserve/v2.3/table/:tableID/record/:recordID/',
  UPDATE_RECORD_LIST: '/hserve/v2.3/table/:tableID/record/?limit=:limit&offset=:offset&where=:where&enable_trigger=:enable_trigger&return_total_count=:return_total_count',
  DELETE_RECORD: '/hserve/v2.3/table/:tableID/record/:recordID/',
  DELETE_RECORD_LIST: '/hserve/v2.3/table/:tableID/record/?limit=:limit&offset=:offset&where=:where&enable_trigger=:enable_trigger&return_total_count=:return_total_count',
