...
const API = {
  ...
  WECHAT: {
    ...
    DECRYPT: '/hserve/v2.7/wechat/decrypt/',
    DECRYPT_OLD: '/hserve/v1/wechat/decrypt/',
    ...
    PHONE_LOGIN: '/hserve/v2.7/idp/wechat/phone-login/',
    PHONE_LOGIN_OLD: '/hserve/v2.5/idp/wechat/phone-login/',
    UPDATE_PHONE: '/hserve/v2.7/idp/wechat/phone-verification/',
    UPDATE_PHONE_OLD: '/hserve/v2.5/idp/wechat/phone-verification/',
    ...
    PRIVATE_MESSAGE: '/hserve/v2.5/private-message/',
  },
