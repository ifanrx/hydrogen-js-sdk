...
const API = {
  ...
  CREATE_RECORD_LIST: '/hserve/v1.5/table/:tableID/record/?enable_trigger=:enable_trigger',
  ...
  UPDATE_RECORD_LIST: '/hserve/v1.5/table/:tableID/record/?limit=:limit&offset=:offset&where=:where&enable_trigger=:enable_trigger',
  DELETE_RECORD: '/hserve/v1.4/table/:tableID/record/:recordID/',
  DELETE_RECORD_LIST: '/hserve/v1.5/table/:tableID/record/?limit=:limit&offset=:offset&where=:where&enable_trigger=:enable_trigger',
